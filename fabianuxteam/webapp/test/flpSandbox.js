		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fabians UX Team",
									"targetURL": "#e4uuxtfabianuxteam-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"e4uuxtfabianuxteam-display": {
								"semanticObject": "e4uuxtfabianuxteam",
								"action": "display",
								"description": "Test aus RAP Service Freestyle Fiori",
								"title": "Fabians UX Team",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=e4u.uxt.fabianuxteam",
									"url": sap.ui.require.toUrl("e4u/uxt/fabianuxteam")
								}
							}
						}
					}
