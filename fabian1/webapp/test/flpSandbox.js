		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fabian1",
									"targetURL": "#fabian1fabian1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fabian1fabian1-display": {
								"semanticObject": "fabian1fabian1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fabian1.fabian1",
									"url": sap.ui.require.toUrl("fabian1/fabian1")
								}
							}
						}
					}
